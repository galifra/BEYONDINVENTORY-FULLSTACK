...
const About = () => {
  return (
    <div className="about-page p-4 max-w-3xl mx-auto text-center">
      ...
      <p className="mb-2">
        This app helps you organize your inventory efficiently by using intuitive design and interactive features, making inventory management simple and effective.      </p>
      <p>
